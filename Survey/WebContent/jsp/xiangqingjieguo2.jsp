...
<!-- <link rel="stylesheet" href="./投票结果_files/bootstrap.min.css"
	type="text/css">
<link href="./投票结果_files/voteDetail.css" rel="stylesheet"
	type="text/css">
<link href="./投票结果_files/crumbs.css" rel="stylesheet" type="text/css">

<script charset="UTF-8" src="./投票结果_files/bundle.js"></script>
<script charset="UTF-8" src="./投票结果_files/iframeWidget.js"></script> -->
					...
					<div class="vote vote-sub voteDet panel panel-default">
						<div class="panel-body">
							...
							<div class="row">
								<ul class="pager">
									<li class="next"><a
										href="${pageContext.request.contextPath}/console/kongzhitai.shtml">返回控制台一览&gt;&gt;</a></li>
								</ul>
							</div>
						</div>
					</div>
